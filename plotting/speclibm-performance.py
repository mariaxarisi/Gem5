...
perf_dir = os.path.join(cur_dir, '..', 'spec-performance-opt', 'speclibm')
assets_dir = os.path.join(cur_dir, '..', 'assets', 'speclibm')
...
plt.xlabel("L1D Size")
plt.ylabel("CPI")
plt.title("speclibm: CPI vs L1D Size")
plt.grid(True)
...
plt.ylabel("CPI")
plt.title("speclibm: CPI vs L1D Associativity")
plt.grid(True)
...
plt.xlabel("L2 Size")
plt.ylabel("CPI")
plt.title("speclibm: CPI vs L2 Size")
plt.grid(True)
...
plt.ylabel("CPI")
plt.title("speclibm: CPI vs L2 Associativity")
plt.grid(True)
...
plt.ylabel("CPI")
plt.title("speclibm: CPI vs Cache Line Size")
plt.grid(True)
