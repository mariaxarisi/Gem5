...
OUT_ROOT="${REPO_ROOT}/spec-performance-opt/specsjeng"
...
run_config() {
  ...
  "${GEM5_BIN}" \
    ...
    -c "${GEM5_DIR}/spec_cpu2006/458.sjeng/src/specsjeng" \
    -o "${GEM5_DIR}/spec_cpu2006/458.sjeng/data/test.txt" \
    -I 100000000
...
# 5) Sweep line size: 16, 32, 64, 128 B
...
run_config "${BASE_L1D_SIZE}" "${BASE_L1D_ASSOC}" "4MB" "${BASE_L2_ASSOC}" "128"