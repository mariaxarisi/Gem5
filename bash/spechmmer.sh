...
OUT_ROOT="${REPO_ROOT}/spec-performance-opt/spechmmer"
...
run_config() {
  ...
  local code="${l1i_size}_${BASE_L1I_ASSOC}_${l1d_size}_${BASE_L1D_ASSOC}_${l2_size}_${BASE_L2_ASSOC}_${BASE_LINE_SIZE}"
  ...
  "${GEM5_BIN}" \
    ...
    -c "${GEM5_DIR}/spec_cpu2006/456.hmmer/src/spechmmer" \
    -o "--fixed 0 --mean 325 --num 45000 --sd 200 --seed 0 ${GEM5_DIR}/spec_cpu2006/456.hmmer/data/bombesin.hmm" \
    -I 100000000
